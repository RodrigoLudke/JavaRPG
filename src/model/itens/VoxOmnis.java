...
public class VoxOmnis extends Itens{
    private static final String NOME = "Vox Omnis";
    private static final String TIPO = "Arma";
    private static final boolean PODE_USAR_EM_COMBATE = true;
    private static final int BONUS_FA = 10;
    private static final int BONUS_DANO = 20;
