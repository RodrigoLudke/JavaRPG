...
public class SilvertongueExe extends Missoes {
    ...
    public void executar(Personagem personagem, JogoController jogo) throws InterruptedException {
        ...
        introduzirMissao();
        apresentarEscolhas(personagem, jogo);
        verificarConclusao();
        sc.close();
    }
    ...
    private void apresentarEscolhas(Personagem personagem, JogoController jogo) throws InterruptedException {
        ...
        switch (decisao) {
            case 1 -> finalTragicoDestruicao();
            case 2 -> finalFusaoSilvertongue(personagem, jogo);
            case 3 -> finalHeroicoDominacao();
            default -> finalFracasso();
        }
    }

    private void finalTragicoDestruicao() throws InterruptedException {
    ...
    private void finalFusaoSilvertongue(Personagem personagem, JogoController jogo) throws InterruptedException {
    ...
    private void finalHeroicoDominacao() throws InterruptedException {
    ...
    private void finalFracasso() throws InterruptedException {
